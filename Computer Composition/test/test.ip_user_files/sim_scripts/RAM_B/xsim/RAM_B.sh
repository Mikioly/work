...
#
# Script generated by Vivado on Tue Apr 02 16:55:46 +0800 2024
...
# script info
echo -e "RAM_B.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot RAM_B xil_defaultlib.RAM_B xil_defaultlib.glbl -log elaborate.log
}
